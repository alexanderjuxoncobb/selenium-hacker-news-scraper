...
class EmailNotifier:
            ...
            <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                ...
                <div style="padding: 24px;">
                    ...
                    <div style="border-top: 1px solid #e5e7eb; padding-top: 16px; margin-top: 24px; text-align: center;">
                        ...
                        <a href="{self.dashboard_base_url}/interests{f'/{user_id}' if user_id else ''}" style="color: #ff6600; text-decoration: none; margin: 0 12px;">
                            ⚙️ Manage Interests
                        </a>
                        <a href="{self.dashboard_base_url}/analytics{f'/{user_id}' if user_id else ''}" style="color: #ff6600; text-decoration: none; margin: 0 12px;">
                            📊 View Analytics
                        </a>
                    </div>
                </div>
    ...
    def _generate_text_email(self, date_str: str, total_stories: int, relevant_stories: int, 
        ...
        text_parts.extend([
            "Quick Links:",
            f"⚙️ Manage Interests: {self.dashboard_base_url}/interests{f'/{user_id}' if user_id else ''}",
            f"📊 View Analytics: {self.dashboard_base_url}/analytics{f'/{user_id}' if user_id else ''}",
            "",
