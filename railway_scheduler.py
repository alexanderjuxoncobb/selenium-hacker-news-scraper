...
def run_scheduler():
    ...
    # Schedule the job for 5:28 PM London time (16:28 UTC) - TESTING
    schedule.every().day.at("16:28").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 5:28 PM London time (16:28 UTC) - TESTING")
