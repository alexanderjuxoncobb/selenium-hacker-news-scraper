...
def run_scheduler():
    ...
    # Schedule the job for 4:08 PM London time (15:08 UTC) - TESTING
    schedule.every().day.at("15:08").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 4:08 PM London time (15:08 UTC) - TESTING")
