...
def run_scheduler():
    ...
    # Schedule the job for 2:35 PM London time (13:35 UTC) - TESTING
    schedule.every().day.at("13:35").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 2:35 PM London time (13:35 UTC) - TESTING")
