...
def run_scheduler():
    ...
    # Schedule the job for 7:25 PM London time (18:25 UTC) - TESTING
    schedule.every().day.at("18:25").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 7:25 PM London time (18:25 UTC) - TESTING")
