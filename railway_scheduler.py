...
def run_scheduler():
    ...
    # Schedule the job for 5:50 PM London time (16:50 UTC) - TESTING
    schedule.every().day.at("16:50").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 5:50 PM London time (16:50 UTC) - TESTING")
