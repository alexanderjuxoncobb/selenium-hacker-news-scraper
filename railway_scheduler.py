...
def run_scheduler():
    ...
    # Schedule the job for 3:17 PM London time (14:17 UTC) - TESTING
    schedule.every().day.at("14:17").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 3:17 PM London time (14:17 UTC) - TESTING")
