...
def run_scheduler():
    ...
    # Schedule the job for 10:32 PM London time (21:32 UTC) - TESTING
    schedule.every().day.at("21:32").do(run_daily_scrape)
    
    print("📅 Scheduler started - Daily scrape at 10:32 PM London time (21:32 UTC) - TESTING")
