...
Runs the multi-user scraper at 9:40 PM London time every day
...
def main():
    ...
    print("⏰ Scheduled to run at 9:40 PM London time every day")
    
    # Schedule the job for 9:40 PM London time
    schedule.every().day.at("21:40").do(run_daily_scraper)
